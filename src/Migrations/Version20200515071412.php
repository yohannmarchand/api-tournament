 ...
 */
final class Version20200515071412 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE players (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        $this->addSql('CREATE TABLE players_tournament (players_id INTEGER NOT NULL, tournament_id INTEGER NOT NULL, PRIMARY KEY(players_id, tournament_id))');
        $this->addSql('CREATE INDEX IDX_9B18374DF1849495 ON players_tournament (players_id)');
        $this->addSql('CREATE INDEX IDX_9B18374D33D1A3E7 ON players_tournament (tournament_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE players_tournament');
        $this->addSql('DROP INDEX IDX_7A5BC50533D1A3E7');
        $this->addSql('CREATE TEMPORARY TABLE __temp__match AS SELECT id, tournament_id, player_1, player_2, point_1, point_2, type, created_at FROM "match"');
        $this->addSql('DROP TABLE "match"');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tournament AS SELECT id, club_id, name, type, nb_poule, created_at, category FROM tournament');
        $this->addSql('DROP TABLE tournament');
        $this->addSql('CREATE TABLE tournament (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, club_id INTEGER DEFAULT NULL, name VARCHAR(50) NOT NULL, type VARCHAR(30) NOT NULL, nb_poule INTEGER NOT NULL, created_at DATETIME NOT NULL, category VARCHAR(20) NOT NULL, winner_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO tournament (id, club_id, name, type, nb_poule, created_at, category) SELECT id, club_id, name, type, nb_poule, created_at, category FROM __temp__tournament');
        $this->addSql('DROP TABLE __temp__tournament');
        $this->addSql('CREATE INDEX IDX_BD5FB8D961190A32 ON tournament (club_id)');
